...
public class ArtsAndCraftsGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        add("lotus_pistils_from_sniffer", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.SNIFFER_DIGGING.location()).build() }, KekeItems.LOTUS_PISTILS.get()));

        //COMMON ARCHAEOLOGY
        add("ruined_pottery_sherd_from_archaeology_common", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_COMMON.location()).build() }, KekeItems.RUINED_POTTERY_SHERD.get()));

        add("pottery_sherd_from_archaeology_common", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_COMMON.location()).build() }, KekeItems.POTTERY_SHERD.get()));

        add("bleachdew_from_archaeology_common", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_COMMON.location()).build() }, KekeItems.BLEACHDEW.get()));

        add("cork_hanging_sign_from_archaeology_common", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_COMMON.location()).build() }, KekeItems.CORK_HANGING_SIGN.get()));

        //RARE ARCHAEOLOGY
        add("ruined_pottery_sherd_from_archaeology_rare", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_RARE.location()).build() }, KekeItems.RUINED_POTTERY_SHERD.get()));

        add("roll_pottery_sherd_from_archaeology_rare", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_RARE.location()).build() }, KekeItems.ROLL_POTTERY_SHERD.get()));

        add("finale_pottery_sherd_from_archaeology_rare", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_RARE.location()).build() }, KekeItems.FINALE_POTTERY_SHERD.get()));

        add("gateway_pottery_sherd_from_archaeology_rare", new ModifyItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_RARE.location()).build() }, KekeItems.GATEWAY_POTTERY_SHERD.get()));
    }
}