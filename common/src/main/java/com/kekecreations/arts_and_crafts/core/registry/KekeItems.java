...
public class KekeItems {
    ...
    public static final Supplier<CustomBoatItem> CORK_BOAT = RegistryHelper.registerItem("cork_boat", () -> new CustomBoatItem(false, CustomBoat.WoodType.CORK, new Item.Properties().stacksTo(1)));
