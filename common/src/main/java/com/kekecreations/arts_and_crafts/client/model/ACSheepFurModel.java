package com.kekecreations.arts_and_crafts.client.model;
...
public class ACSheepFurModel<T extends ACSheep> extends QuadrupedModel<T> {
    private float headXRot;

    public ACSheepFurModel(ModelPart modelPart) {
