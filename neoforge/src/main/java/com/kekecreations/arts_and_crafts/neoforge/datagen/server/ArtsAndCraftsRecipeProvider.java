...
public class ArtsAndCraftsRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    public ArtsAndCraftsRecipeProvider(PackOutput p_248933_, CompletableFuture<HolderLookup.Provider> p_323846_) {
    ...
    protected void buildRecipes(RecipeOutput recipeConsumer) {
        ...
        for (PietraforteColour colour : PietraforteColour.values()) {
            simpleCookingRecipe(recipeConsumer, RecipeSerializer.SMELTING_RECIPE, ACBlocks.getCobbledPietraforte(colour), ACBlocks.getPietraforte(colour), RecipeCategory.BUILDING_BLOCKS, 5F, 150, "pietraforte", "_smelting");
    ...
    protected static void smeltingRecipe(Block craftingBlock, Block resultBlock, RecipeCategory recipeCategory, float experience, RecipeOutput recipeConsumer) {
    ...
    protected static void bleachBannerRecipe(Block craftingBlock, DyeColor dyeColour, String group, RecipeOutput recipeConsumer) {
    ...
    protected static void dyeBlockRecipe(Block craftingBlock, DyeColor dyeColour, Block resultBlock, String group, RecipeOutput recipeConsumer) {
    ...
    protected static void colourChangeRecipe(Block craftingBlock, Item craftingItem, Block resultBlock, RecipeOutput recipeConsumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, resultBlock ,4)
                .pattern("XK")
                .pattern("KX")
                .define('K', craftingBlock)
    ...
    protected static void colourChangeRecipe(String string, Block craftingBlock, Item craftingItem, Block resultBlock, RecipeOutput recipeConsumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, resultBlock ,4)
                .pattern("XK")
                .pattern("KX")
                .define('K', craftingBlock)
    ...
    protected static void chiseledOrPillarRecipe(Block craftingBlock, Block resultBlock, int count, String string, RecipeOutput recipeConsumer) {
    ...
    protected static void paintbrushRecipe(Item item, Item paintbrushItem, RecipeOutput recipeConsumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, paintbrushItem,1)
                .pattern("KK")
                .pattern("KQ")
                .define('K', item)
    ...
    public static void chestBoatRecipe(RecipeOutput consumer, ItemLike itemLike, ItemLike itemLike2) {
    ...
    protected static void colorBlockWithDye(RecipeOutput p_289666_, List<Item> p_289675_, List<Item> p_289672_, String p_289641_) {
    ...
    protected static void colorBleachedBlockWithDye(RecipeOutput p_289666_, List<Item> p_289675_, List<Item> p_289672_, ItemLike bleachedBlock, String p_289641_) {
        for(int i = 0; i < p_289675_.size(); ++i) {
            Item item = p_289675_.get(i);
            Item item1 = p_289672_.get(i);
    ...
    protected static void bleachBlockAlt(RecipeOutput p_289666_, List<Item> itemList, ItemLike bleachedBlock, String string) {
    ...
    protected static void bleachBlock(RecipeOutput p_289666_, List<Item> p_289675_, ItemLike bleachedBlock, String p_289641_) {
    ...
    protected static void stonecutterRecipes(RecipeCategory category, Item ingredient, Item result, int resultCount, RecipeOutput consumer) {
    ...
    protected static void stonecutterRecipes(RecipeCategory category, Supplier<? extends ItemLike> ingredient, Supplier<? extends ItemLike> result, int resultCount, RecipeOutput consumer) {
    ...
    private static void planksFromLogsRecipe(Supplier<? extends ItemLike> pLogs, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
    ...
    private static void woodFromLogsRecipe(Supplier<? extends ItemLike> pLog, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
    ...
    private static void fenceRecipe(Supplier<? extends ItemLike> ingredient, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
    ...
    private static void pressurePlateRecipe(Supplier<? extends ItemLike> ingredient, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result.get()).define('#', ingredient.get()).pattern("##")
                .unlockedBy(getHasName(ingredient.get()), has(ingredient.get())).save(consumer);
    }

    private static void doorRecipe(Supplier<? extends ItemLike> ingredient, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result.get(), 3).define('#', ingredient.get()).pattern("##").pattern("##").pattern("##")
                .unlockedBy(getHasName(ingredient.get()), has(ingredient.get())).save(consumer);
    }

    private static void trapdoorRecipe(Supplier<? extends ItemLike> ingredient, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result.get(), 2).define('#', ingredient.get()).pattern("###").pattern("###")
                .unlockedBy(getHasName(ingredient.get()), has(ingredient.get())).save(consumer);
    }

    private static void fenceGateRecipe(Supplier<? extends ItemLike> ingredient, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
    ...
    private static void signRecipe(Supplier<? extends ItemLike> ingredient, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
    ...
    private static void hangingSignRecipe(Supplier<? extends ItemLike> ingredient, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
    ...
    protected static void buttonRecipes(RecipeCategory category, ItemLike ingredient, Supplier<? extends ItemLike> result, RecipeOutput consumer) {
    ...
    protected static void simpleCookingRecipe(RecipeOutput consumer, RecipeSerializer<? extends AbstractCookingRecipe> recipeSerializer, ItemLike craftingItem, ItemLike p_250066_, RecipeCategory p_251154_, float xp, int time, String p_251450_, String p_249236_) {
        if (recipeSerializer == RecipeSerializer.SMELTING_RECIPE) {
            SimpleCookingRecipeBuilder.smelting(Ingredient.of(craftingItem), p_251154_, p_250066_, xp, time).group(p_251450_).unlockedBy(getHasName(craftingItem), has(craftingItem)).save(consumer, "arts_and_crafts:" + getItemName(p_250066_) + p_249236_ + "_" + getItemName(craftingItem));
        }
        if (recipeSerializer == RecipeSerializer.BLASTING_RECIPE) {
            SimpleCookingRecipeBuilder.blasting(Ingredient.of(craftingItem), p_251154_, p_250066_, xp, time).group(p_251450_).unlockedBy(getHasName(craftingItem), has(craftingItem)).save(consumer, "arts_and_crafts:" + getItemName(p_250066_) + p_249236_ + "_" + getItemName(craftingItem));
        }
    }
}