...
public class BleachDecoratedPotRecipe extends CustomRecipe {
    public BleachDecoratedPotRecipe(ResourceLocation resourceLocation, CraftingBookCategory craftingBookCategory) {
    ...
    public @NotNull ItemStack assemble(CraftingContainer craftingContainer, @NotNull RegistryAccess registryAccess) {
        ...
        ItemStack itemStack3 = Items.DECORATED_POT.getDefaultInstance();
        if (itemStack.hasTag()) {
    ...
    public RecipeSerializer<?> getSerializer() {
        return ACRecipeSerializer.BLEACH_DECORATED_POT_RECIPE.get();
    }
