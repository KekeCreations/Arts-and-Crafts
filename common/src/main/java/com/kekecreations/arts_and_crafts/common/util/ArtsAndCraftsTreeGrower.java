...
public class ArtsAndCraftsTreeGrower {

    public static final TreeGrower CORK = register("cork", Optional.of(KekeFeatures.ConfiguredFeatures.CORK_TREE), Optional.empty());
