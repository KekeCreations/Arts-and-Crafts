...
public class KekeBlocks {
    ...
    public static final RegistrySupplier<Block> OLIVE_CHALK = RegistryHelper.BLOCKS.register("olive_chalk", () -> new Block(BlockBehaviour.Properties.of().mapColor(DyeColor.MAGENTA).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(0.8f)));
    ...
    public static final RegistrySupplier<Block> PINE_CHALK = RegistryHelper.BLOCKS.register("pine_chalk", () -> new Block(BlockBehaviour.Properties.of().mapColor(DyeColor.GREEN).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(0.8f)));
    ...
    public static final RegistrySupplier<Block> TAN_CHALK = RegistryHelper.BLOCKS.register("tan_chalk", () -> new Block(BlockBehaviour.Properties.of().mapColor(DyeColor.RED).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(0.8f)));
    ...
    public static final RegistrySupplier<Block> TURQUOISE_CHALK = RegistryHelper.BLOCKS.register("turquoise_chalk", () -> new Block(BlockBehaviour.Properties.of().mapColor(DyeColor.LIGHT_BLUE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(0.8f)));
