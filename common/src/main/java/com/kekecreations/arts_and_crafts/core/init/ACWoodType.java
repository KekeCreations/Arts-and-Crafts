...
public class ACWoodType {
    ...
    public static final WoodType CORK = WoodTypeInvoker.invokeRegister(new WoodType(ArtsAndCrafts.id("cork").toString(), ACBlocks.CORK_SET, ACSoundTypes.CORK, SoundType.CHERRY_WOOD_HANGING_SIGN, ACSounds.CORK_WOOD_FENCE_GATE_CLOSE.get(), ACSounds.CORK_WOOD_FENCE_GATE_OPEN.get()));
}
