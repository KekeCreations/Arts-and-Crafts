...
public enum PietraforteColour implements StringRepresentable {
    ...
    private static final IntFunction<PietraforteColour> BY_ID = ByIdMap.continuous(PietraforteColour::getId, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
    public static final StringRepresentable.EnumCodec<PietraforteColour> CODEC = StringRepresentable.fromEnum(PietraforteColour::values);
    private final int id;
    private final String name;
    private final MapColor colour;

    private PietraforteColour(int j, String string2, MapColor colour) {
        this.id = j;
        this.name = string2;
        this.colour = colour;
    }
    ...
    public static PietraforteColour byName(String string, @Nullable PietraforteColour dyeColor) {
        PietraforteColour dyeColor2 = CODEC.byName(string);
