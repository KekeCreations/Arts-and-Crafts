...
public class ArtsAndCraftsBlockStateProvider extends BlockStateProvider {
    ...
    public void chalkDustBlock(Block block, String dyeColor) {
        ...
        getVariantBuilder(block)
                //Chalk Pattern 0
                .partialState().with(ACProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor + "_dot").texture("dust", dot).texture("particle", dot)).build())
                .partialState().with(ACProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 1
                .partialState().with(ACProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 2
                .partialState().with(ACProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 3
                .partialState().with(ACProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 4
                .partialState().with(ACProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 5
                .partialState().with(ACProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 6
                .partialState().with(ACProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 7
                .partialState().with(ACProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 8
                .partialState().with(ACProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 9
                .partialState().with(ACProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 10
                .partialState().with(ACProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 11
                .partialState().with(ACProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor + "_plus").texture("dust", plus).texture("particle", plus)).build())
                .partialState().with(ACProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 12
                .partialState().with(ACProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 13
                .partialState().with(ACProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 14
                .partialState().with(ACProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor + "_x").texture("dust", x).texture("particle", x)).build())
                .partialState().with(ACProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 15
                .partialState().with(ACProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 16
                .partialState().with(ACProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 17
                .partialState().with(ACProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 18
                .partialState().with(ACProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 19
                .partialState().with(ACProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 20
                .partialState().with(ACProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 21
                .partialState().with(ACProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 22
                .partialState().with(ACProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 23
                .partialState().with(ACProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 24
                .partialState().with(ACProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 25
                .partialState().with(ACProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 26
                .partialState().with(ACProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 27
                .partialState().with(ACProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 28
                .partialState().with(ACProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 29
                .partialState().with(ACProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 30
                .partialState().with(ACProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 31
                .partialState().with(ACProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.DOWN)
                ...
                //Chalk Pattern 32
                .partialState().with(ACProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.UP)
                ...
                .partialState().with(ACProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.DOWN)
    ...
    public void hangingFlowerPotBlock(Block plank, String plankModId, Block hangingFlowerPot) {
        getVariantBuilder(hangingFlowerPot)
                .partialState().with(ACProperties.PLANK, false).with(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH)
                ...
                .partialState().with(ACProperties.PLANK, true).with(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH)
                ...
                //EAST
                .partialState().with(ACProperties.PLANK, false).with(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST)
                ...
                .partialState().with(ACProperties.PLANK, true).with(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST)
                ...
                //SOUTH
                .partialState().with(ACProperties.PLANK, false).with(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH)
                ...
                .partialState().with(ACProperties.PLANK, true).with(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH)
                ...
                //WEST
                .partialState().with(ACProperties.PLANK, false).with(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST)
                ...
                .partialState().with(ACProperties.PLANK, true).with(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST)
