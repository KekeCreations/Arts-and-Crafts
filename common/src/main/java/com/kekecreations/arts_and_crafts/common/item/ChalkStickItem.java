...
public class ChalkStickItem extends Item {
    ...
    public int getChalkPattern(ItemStack itemStack) {
        ...
        int compoundTag = itemStack.getComponents().getOrDefault(ArtsAndCraftsDataComponents.CHALK_PATTERN, -1);
        if (compoundTag != -1) {
            return compoundTag;
        } else {
            return 100;
    ...
    public void setChalkPattern(ItemStack itemStack, int chalkPattern) {
        itemStack.set(ArtsAndCraftsDataComponents.CHALK_PATTERN, chalkPattern);
    ...
    public InteractionResult useOn(UseOnContext useOnContext) {
        ...
        if (!level.isClientSide()) {
            ...
            if (itemStack.get(ArtsAndCraftsDataComponents.CHALK_PATTERN) != null) {
