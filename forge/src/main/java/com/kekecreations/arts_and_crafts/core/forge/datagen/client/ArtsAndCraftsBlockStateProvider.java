...
public class ArtsAndCraftsBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        for (DyeColor colours : DyeColor.values()) {
            ...
            chalkDustBlock(KekeBlocks.getChalkDust(colours), colours);
    ...
    public void chalkDustBlock(Block block, DyeColor dyeColor) {
        ...
        getVariantBuilder(block)
                ...
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_dot").texture("dust", dot).texture("particle", dot)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_dot").texture("dust", dot).texture("particle", dot)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_dot").texture("dust", dot).texture("particle", dot)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_dot").texture("dust", dot).texture("particle", dot)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_dot").texture("dust", dot).texture("particle", dot)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 0).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_dot").texture("dust", dot).texture("particle", dot)).rotationX(270).build())
                //Chalk Pattern 1
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_vertical_line_middle").texture("dust", verticalLine).texture("particle", verticalLine)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_vertical_line_middle").texture("dust", verticalLine).texture("particle", verticalLine)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_vertical_line_middle").texture("dust", verticalLine).texture("particle", verticalLine)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_vertical_line_middle").texture("dust", verticalLine).texture("particle", verticalLine)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_vertical_line_middle").texture("dust", verticalLine).texture("particle", verticalLine)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 1).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_vertical_line_middle").texture("dust", verticalLine).texture("particle", verticalLine)).rotationX(270).build())
                //Chalk Pattern 2
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_rotated_line_middle").texture("dust", rotatedLine).texture("particle", rotatedLine)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_rotated_line_middle").texture("dust", rotatedLine).texture("particle", rotatedLine)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_rotated_line_middle").texture("dust", rotatedLine).texture("particle", rotatedLine)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_rotated_line_middle").texture("dust", rotatedLine).texture("particle", rotatedLine)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_rotated_line_middle").texture("dust", rotatedLine).texture("particle", rotatedLine)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 2).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_rotated_line_middle").texture("dust", rotatedLine).texture("particle", rotatedLine)).rotationX(270).build())
                //Chalk Pattern 3
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_0").texture("dust", corner0).texture("particle", corner0)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_0").texture("dust", corner0).texture("particle", corner0)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_0").texture("dust", corner0).texture("particle", corner0)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_0").texture("dust", corner0).texture("particle", corner0)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_0").texture("dust", corner0).texture("particle", corner0)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 3).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_0").texture("dust", corner0).texture("particle", corner0)).rotationX(270).build())
                //Chalk Pattern 4
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_1").texture("dust", corner1).texture("particle", corner1)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_1").texture("dust", corner1).texture("particle", corner1)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_1").texture("dust", corner1).texture("particle", corner1)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_1").texture("dust", corner1).texture("particle", corner1)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_1").texture("dust", corner1).texture("particle", corner1)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 4).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_1").texture("dust", corner1).texture("particle", corner1)).rotationX(270).build())
                //Chalk Pattern 5
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_2").texture("dust", corner2).texture("particle", corner2)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_2").texture("dust", corner2).texture("particle", corner2)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_2").texture("dust", corner2).texture("particle", corner2)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_2").texture("dust", corner2).texture("particle", corner2)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_2").texture("dust", corner2).texture("particle", corner2)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 5).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_2").texture("dust", corner2).texture("particle", corner2)).rotationX(270).build())
                //Chalk Pattern 6
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_3").texture("dust", corner3).texture("particle", corner3)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_3").texture("dust", corner3).texture("particle", corner3)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_3").texture("dust", corner3).texture("particle", corner3)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_3").texture("dust", corner3).texture("particle", corner3)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_3").texture("dust", corner3).texture("particle", corner3)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 6).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_corner_3").texture("dust", corner3).texture("particle", corner3)).rotationX(270).build())
                //Chalk Pattern 7
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_0").texture("dust", tCross0).texture("particle", tCross0)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_0").texture("dust", tCross0).texture("particle", tCross0)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_0").texture("dust", tCross0).texture("particle", tCross0)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_0").texture("dust", tCross0).texture("particle", tCross0)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_0").texture("dust", tCross0).texture("particle", tCross0)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 7).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_0").texture("dust", tCross0).texture("particle", tCross0)).rotationX(270).build())
                //Chalk Pattern 8
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_1").texture("dust", tCross1).texture("particle", tCross1)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_1").texture("dust", tCross1).texture("particle", tCross1)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_1").texture("dust", tCross1).texture("particle", tCross1)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_1").texture("dust", tCross1).texture("particle", tCross1)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_1").texture("dust", tCross1).texture("particle", tCross1)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 8).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_1").texture("dust", tCross1).texture("particle", tCross1)).rotationX(270).build())
                //Chalk Pattern 9
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_2").texture("dust", tCross2).texture("particle", tCross2)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_2").texture("dust", tCross2).texture("particle", tCross2)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_2").texture("dust", tCross2).texture("particle", tCross2)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_2").texture("dust", tCross2).texture("particle", tCross2)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_2").texture("dust", tCross2).texture("particle", tCross2)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 9).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_2").texture("dust", tCross2).texture("particle", tCross2)).rotationX(270).build())
                //Chalk Pattern 10
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_3").texture("dust", tCross3).texture("particle", tCross3)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_3").texture("dust", tCross3).texture("particle", tCross3)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_3").texture("dust", tCross3).texture("particle", tCross3)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_3").texture("dust", tCross3).texture("particle", tCross3)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_3").texture("dust", tCross3).texture("particle", tCross3)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 10).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_t_cross_3").texture("dust", tCross3).texture("particle", tCross3)).rotationX(270).build())
                //Chalk Pattern 11
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_plus").texture("dust", plus).texture("particle", plus)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_plus").texture("dust", plus).texture("particle", plus)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_plus").texture("dust", plus).texture("particle", plus)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_plus").texture("dust", plus).texture("particle", plus)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_plus").texture("dust", plus).texture("particle", plus)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 11).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_plus").texture("dust", plus).texture("particle", plus)).rotationX(270).build())
                //Chalk Pattern 12
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_right").texture("dust", diagonalLineRight).texture("particle", diagonalLineRight)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_right").texture("dust", diagonalLineRight).texture("particle", diagonalLineRight)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_right").texture("dust", diagonalLineRight).texture("particle", diagonalLineRight)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_right").texture("dust", diagonalLineRight).texture("particle", diagonalLineRight)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_right").texture("dust", diagonalLineRight).texture("particle", diagonalLineRight)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 12).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_right").texture("dust", diagonalLineRight).texture("particle", diagonalLineRight)).rotationX(270).build())
                //Chalk Pattern 13
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_left").texture("dust", diagonalLineLeft).texture("particle", diagonalLineLeft)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_left").texture("dust", diagonalLineLeft).texture("particle", diagonalLineLeft)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_left").texture("dust", diagonalLineLeft).texture("particle", diagonalLineLeft)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_left").texture("dust", diagonalLineLeft).texture("particle", diagonalLineLeft)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_left").texture("dust", diagonalLineLeft).texture("particle", diagonalLineLeft)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 13).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_diagonal_line_left").texture("dust", diagonalLineLeft).texture("particle", diagonalLineLeft)).rotationX(270).build())
                //Chalk Pattern 14
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_x").texture("dust", x).texture("particle", x)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_x").texture("dust", x).texture("particle", x)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_x").texture("dust", x).texture("particle", x)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_x").texture("dust", x).texture("particle", x)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_x").texture("dust", x).texture("particle", x)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 14).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_x").texture("dust", x).texture("particle", x)).rotationX(270).build())
                //Chalk Pattern 15
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_0").texture("dust", lineEdge0).texture("particle", lineEdge0)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_0").texture("dust", lineEdge0).texture("particle", lineEdge0)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_0").texture("dust", lineEdge0).texture("particle", lineEdge0)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_0").texture("dust", lineEdge0).texture("particle", lineEdge0)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_0").texture("dust", lineEdge0).texture("particle", lineEdge0)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 15).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_0").texture("dust", lineEdge0).texture("particle", lineEdge0)).rotationX(270).build())
                //Chalk Pattern 16
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_1").texture("dust", lineEdge1).texture("particle", lineEdge1)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_1").texture("dust", lineEdge1).texture("particle", lineEdge1)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_1").texture("dust", lineEdge1).texture("particle", lineEdge1)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_1").texture("dust", lineEdge1).texture("particle", lineEdge1)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_1").texture("dust", lineEdge1).texture("particle", lineEdge1)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 16).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_1").texture("dust", lineEdge1).texture("particle", lineEdge1)).rotationX(270).build())
                //Chalk Pattern 17
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_2").texture("dust", lineEdge2).texture("particle", lineEdge2)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_2").texture("dust", lineEdge2).texture("particle", lineEdge2)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_2").texture("dust", lineEdge2).texture("particle", lineEdge2)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_2").texture("dust", lineEdge2).texture("particle", lineEdge2)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_2").texture("dust", lineEdge2).texture("particle", lineEdge2)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 17).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_2").texture("dust", lineEdge2).texture("particle", lineEdge2)).rotationX(270).build())
                //Chalk Pattern 18
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_3").texture("dust", lineEdge3).texture("particle", lineEdge3)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_3").texture("dust", lineEdge3).texture("particle", lineEdge3)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_3").texture("dust", lineEdge3).texture("particle", lineEdge3)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_3").texture("dust", lineEdge3).texture("particle", lineEdge3)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_3").texture("dust", lineEdge3).texture("particle", lineEdge3)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 18).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_line_edge_3").texture("dust", lineEdge3).texture("particle", lineEdge3)).rotationX(270).build())
                //Chalk Pattern 19
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_0").texture("dust", triangle0).texture("particle", triangle0)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_0").texture("dust", triangle0).texture("particle", triangle0)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_0").texture("dust", triangle0).texture("particle", triangle0)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_0").texture("dust", triangle0).texture("particle", triangle0)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_0").texture("dust", triangle0).texture("particle", triangle0)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 19).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_0").texture("dust", triangle0).texture("particle", triangle0)).rotationX(270).build())
                //Chalk Pattern 20
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_1").texture("dust", triangle1).texture("particle", triangle1)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_1").texture("dust", triangle1).texture("particle", triangle1)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_1").texture("dust", triangle1).texture("particle", triangle1)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_1").texture("dust", triangle1).texture("particle", triangle1)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_1").texture("dust", triangle1).texture("particle", triangle1)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 20).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_1").texture("dust", triangle1).texture("particle", triangle1)).rotationX(270).build())
                //Chalk Pattern 21
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_2").texture("dust", triangle2).texture("particle", triangle2)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_2").texture("dust", triangle2).texture("particle", triangle2)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_2").texture("dust", triangle2).texture("particle", triangle2)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_2").texture("dust", triangle2).texture("particle", triangle2)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_2").texture("dust", triangle2).texture("particle", triangle2)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 21).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_2").texture("dust", triangle2).texture("particle", triangle2)).rotationX(270).build())
                //Chalk Pattern 22
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_3").texture("dust", triangle3).texture("particle", triangle3)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_3").texture("dust", triangle3).texture("particle", triangle3)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_3").texture("dust", triangle3).texture("particle", triangle3)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_3").texture("dust", triangle3).texture("particle", triangle3)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_3").texture("dust", triangle3).texture("particle", triangle3)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 22).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_triangle_3").texture("dust", triangle3).texture("particle", triangle3)).rotationX(270).build())
                //Chalk Pattern 23
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_circle").texture("dust", circle).texture("particle", circle)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_circle").texture("dust", circle).texture("particle", circle)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_circle").texture("dust", circle).texture("particle", circle)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_circle").texture("dust", circle).texture("particle", circle)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_circle").texture("dust", circle).texture("particle", circle)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 23).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_circle").texture("dust", circle).texture("particle", circle)).rotationX(270).build())
                //Chalk Pattern 24
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_square").texture("dust", square).texture("particle", square)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_square").texture("dust", square).texture("particle", square)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_square").texture("dust", square).texture("particle", square)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_square").texture("dust", square).texture("particle", square)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_square").texture("dust", square).texture("particle", square)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 24).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_square").texture("dust", square).texture("particle", square)).rotationX(270).build())
                //Chalk Pattern 25
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_0").texture("dust", blockCorner0).texture("particle", blockCorner0)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_0").texture("dust", blockCorner0).texture("particle", blockCorner0)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_0").texture("dust", blockCorner0).texture("particle", blockCorner0)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_0").texture("dust", blockCorner0).texture("particle", blockCorner0)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_0").texture("dust", blockCorner0).texture("particle", blockCorner0)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 25).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_0").texture("dust", blockCorner0).texture("particle", blockCorner0)).rotationX(270).build())
                //Chalk Pattern 26
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_1").texture("dust", blockCorner1).texture("particle", blockCorner1)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_1").texture("dust", blockCorner1).texture("particle", blockCorner1)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_1").texture("dust", blockCorner1).texture("particle", blockCorner1)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_1").texture("dust", blockCorner1).texture("particle", blockCorner1)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_1").texture("dust", blockCorner1).texture("particle", blockCorner1)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 26).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_1").texture("dust", blockCorner1).texture("particle", blockCorner1)).rotationX(270).build())
                //Chalk Pattern 27
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_2").texture("dust", blockCorner2).texture("particle", blockCorner2)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_2").texture("dust", blockCorner2).texture("particle", blockCorner2)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_2").texture("dust", blockCorner2).texture("particle", blockCorner2)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_2").texture("dust", blockCorner2).texture("particle", blockCorner2)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_2").texture("dust", blockCorner2).texture("particle", blockCorner2)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 27).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_2").texture("dust", blockCorner2).texture("particle", blockCorner2)).rotationX(270).build())
                //Chalk Pattern 28
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_3").texture("dust", blockCorner3).texture("particle", blockCorner3)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_3").texture("dust", blockCorner3).texture("particle", blockCorner3)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_3").texture("dust", blockCorner3).texture("particle", blockCorner3)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_3").texture("dust", blockCorner3).texture("particle", blockCorner3)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_3").texture("dust", blockCorner3).texture("particle", blockCorner3)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 28).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_block_corner_3").texture("dust", blockCorner3).texture("particle", blockCorner3)).rotationX(270).build())
                //Chalk Pattern 29
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_0").texture("dust", arch0).texture("particle", arch0)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_0").texture("dust", arch0).texture("particle", arch0)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_0").texture("dust", arch0).texture("particle", arch0)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_0").texture("dust", arch0).texture("particle", arch0)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_0").texture("dust", arch0).texture("particle", arch0)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 29).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_0").texture("dust", arch0).texture("particle", arch0)).rotationX(270).build())
                //Chalk Pattern 30
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_1").texture("dust", arch1).texture("particle", arch1)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_1").texture("dust", arch1).texture("particle", arch1)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_1").texture("dust", arch1).texture("particle", arch1)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_1").texture("dust", arch1).texture("particle", arch1)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_1").texture("dust", arch1).texture("particle", arch1)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 30).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_1").texture("dust", arch1).texture("particle", arch1)).rotationX(270).build())
                //Chalk Pattern 31
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_2").texture("dust", arch2).texture("particle", arch2)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_2").texture("dust", arch2).texture("particle", arch2)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_2").texture("dust", arch2).texture("particle", arch2)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_2").texture("dust", arch2).texture("particle", arch2)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_2").texture("dust", arch2).texture("particle", arch2)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 31).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_2").texture("dust", arch2).texture("particle", arch2)).rotationX(270).build())
                //Chalk Pattern 32
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.NORTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_3").texture("dust", arch3).texture("particle", arch3)).rotationY(180).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.EAST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_3").texture("dust", arch3).texture("particle", arch3)).rotationY(270).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.SOUTH)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_3").texture("dust", arch3).texture("particle", arch3)).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.WEST)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_3").texture("dust", arch3).texture("particle", arch3)).rotationY(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.UP)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_3").texture("dust", arch3).texture("particle", arch3)).rotationX(90).build())
                .partialState().with(KekeBlockStateProperties.CHALK_PATTERN, 32).with(BlockStateProperties.FACING, Direction.DOWN)
                .addModels(ConfiguredModel.builder().modelFile(chalkDustModel(dyeColor.getName() + "_arch_3").texture("dust", arch3).texture("particle", arch3)).rotationX(270).build());
    }
