...
public class CustomDecoratedPotRenderer implements BlockEntityRenderer<CustomDecoratedPotBlockEntity> {
    ...
    private void renderSide(ModelPart modelPart, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j, Item item,  CustomDecoratedPotBlockEntity pot) {
    ...
    private ResourceLocation renderMaterial(CustomDecoratedPotBlockEntity potEntity, Item item) {
